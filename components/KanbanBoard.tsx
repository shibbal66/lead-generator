...
const KanbanBoard: React.FC<KanbanBoardProps> = ({ leads, onLeadClick, onAddDeal, lang }) => {
  ...
  const getStageTitle = (stage: PipelineStage) => {
    switch(stage) {
      case PipelineStage.IDENTIFIED: return t.pipeline.stages.IDENTIFIED;
      case PipelineStage.CONTACTED: return t.pipeline.stages.CONTACTED;
      case PipelineStage.QUALIFIED: return t.pipeline.stages.QUALIFIED;
      case PipelineStage.NEGOTIATION: return t.pipeline.stages.NEGOTIATION;
      case PipelineStage.CLOSED: return t.pipeline.stages.CLOSED;
